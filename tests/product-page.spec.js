...
test('סטאר X – רק בחירת צבע אגוז (מידה כבר מסומנת 57) => מחיר 1,990 ש"ח', async ({ page }) => {
  ...
  await page.setDefaultTimeout(time_out);
  await page.goto('https://oz.star.co.il/product/%d7%9e%d7%90%d7%95%d7%95%d7%a8%d7%a8-%d7%aa%d7%a7%d7%a8%d7%94-%d7%a1%d7%98%d7%90%d7%a8-x/');
...
test('סטאר 7 – מידה 52 עם צבע כבר מסומן => מחיר 1,200 ש"ח', async ({ page }) => {
	test.setTimeout(120000);
  await page.setDefaultTimeout(time_out);
  await page.goto('https://oz.star.co.il/product/%d7%9e%d7%90%d7%95%d7%95%d7%a8%d7%a8-%d7%aa%d7%a7%d7%a8%d7%94-%d7%a1%d7%98%d7%90%d7%a8-7/');
  await page.waitForLoadState('networkidle');
